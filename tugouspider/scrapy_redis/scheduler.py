...
class Scheduler(object):
    ...
    def __init__(self, server, persist, queue_key, queue_cls, dupefilter_key,settings):
    ...
    def from_settings(cls, settings):
        ...
        return cls(server, persist, queue_key,queue_cls, dupefilter_key,settings)
    ...
    def open(self, spider):
        ...
        self.df = RFPDupeFilter(self.settings,self.spider.name)
